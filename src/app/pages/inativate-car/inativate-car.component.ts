...
@Component({
  ...
  styleUrls: ['./inativate-car.component.scss']
})
export class InativateCarComponent implements OnInit {
  veiculo: any;
  ...
  onInativar() {
    ...
    this.veiculoService.inativarVeiculo(veiculoId, token).subscribe({
      next: () => {
        this.alertService.success('Veículo inativado com sucesso!');
